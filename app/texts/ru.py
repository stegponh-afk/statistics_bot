...
MAIN_MENU_TITLE = (
    ...
    "приветствие новичков, отчёты в личку, награда за подписку.\n"
    "🤖 <b>Боты</b> — подключить свой бот: проверка подписки на ваши каналы.\n"
    "📨 <b>Рассылка</b> — отправить сообщение в ваши чаты: сразу, по времени "
    "или по расписанию.\n\n"
...
BOTS_TITLE = (
    "🤖 <b>Боты</b>\n"
    f"{SEPARATOR}\n"
    "Здесь подключаются ваши собственные боты: для каждого выдаётся ссылка (API-ключ), "
    "по которой ваш бот проверяет, подписан ли его пользователь на ваши каналы.\n\n"
...
BOT_CREATED = (
    ...
    "<code>{check_url}</code>\n\n"
    "Дальше: привяжите каналы («Каналы») и откройте «Как подключить»."
)
BOT_CARD = (
    "🤖 <b>{name}</b>\n"
    f"{SEPARATOR}\n"
...
BROADCAST_NO_TARGETS = (
    "📨 <b>Рассылка</b>\n"
    f"{SEPARATOR}\n"
    "Пока некуда рассылать: добавьте этого бота администратором в свои каналы и группы, "
    "они появятся в списке получателей."
)
